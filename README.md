...
The goal is to 'pack' as many projected points into the lineup while remaining below the $50,000 salary cap, so ranking players on the basis of Salary/Projected Points gives us a cost per point metric for comparison. For example, WR Justin Jefferson has a salary of $8200 and is projected to score 19.90 points, yielding a cost of $412.06 per projected point. WR DeAndre Hopkins has a salary of $6200 and is projected to score 15.60 points, yielding a cost of $397.44 per projected point. One can argue that, by comparison, DeAndre Hopkins is the more valuable player as he is projected to score more points per dollar and use up $2000 less cap space than Jefferson, which can be spent on other quality players.        
